...
const I18N = {
  tr: {
    ...
    "submit.better": "Daha iyisini teslim et — {cost}",
    ...
    "toast.worse": "Önceki teslimin daha iyiydi ({cost})",
    "toast.sent": "Teslim edildi: {cost} — daha iyisini bulursan tekrar gönderebilirsin ✓",
    ...
    "board.overallHint": "(3 turun puan toplamı)",
  ...
  en: {
    ...
    "submit.better": "Submit a better one — {cost}",
    ...
    "toast.worse": "Your previous submission was better ({cost})",
    "toast.sent": "Submitted: {cost} — send again if you find something better ✓",
    ...
    "board.overallHint": "(sum of three round scores)",
